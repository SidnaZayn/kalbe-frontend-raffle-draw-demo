<template>
  <aside :class="[
    ...
    <div :class="[
      ...
      <router-link to="/" class="flex items-center gap-2 text-gray-900 dark:text-white font-bold text-lg">
        <img v-if="isExpanded || isHovered || isMobileOpen" class="dark:hidden" src="/Kalbe_Farma_min.png" alt="Logo"
          width="30" height="40" />
